...
public class YahooStockNameListGeneratorTest {
	...
	public void fillWithIndexesFromBase() {
		...
		final YahooStockNameListGenerator listGenerator = new YahooStockNameListGenerator();
		listGenerator.fillWithIndexesFromBase(repo, builder);
	...
	public void fillWithExistedFilesFromFolder() throws URISyntaxException {
		...
		new YahooStockNameListGenerator().fillWithExistedFilesFromFolder(folderPath, bForExisted);
